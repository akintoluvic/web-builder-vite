      ...
      <div class="flex flex-wrap -mx-4 -my-8">
        <div class="py-8 px-4 lg:w-1/3">
          <div class="h-full flex items-start">
            ...
            >
              <span
                class="text-gray-500 dark:text-gray-400 pb-2 mb-2 border-b-2 border-gray-200 dark:border-gray-700"
              >
                Jul
              </span>
              <span
                class="font-medium text-lg leading-none text-gray-800 dark:text-gray-300 title-font"
              >
                18
              </span>
            </div>
            <div class="flex-grow pl-6">
              <h2
                class="tracking-widest text-xs title-font font-medium mb-1"
                :class="textColor"
              >
                CATEGORY
              </h2>
              <h1
                class="title-font text-xl font-medium text-gray-900 dark:text-white mb-3"
              >
                The 400 Blows
              </h1>
