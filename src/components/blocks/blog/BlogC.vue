<template>
  <section
    class="text-gray-600 dark:text-gray-400 dark:bg-gray-900 body-font overflow-hidden"
  >
    <div class="container px-5 py-24 mx-auto">
      <div class="flex flex-wrap -m-12">
        <div class="p-12 md:w-1/2 flex flex-col items-start">
          ...
          <h2
            class="sm:text-3xl text-2xl title-font font-medium text-gray-900 dark:text-white mt-4 mb-4"
          >
          ...
          <div
            class="flex items-center flex-wrap pb-4 mb-4 border-b-2 border-gray-100 dark:border-gray-800 dark:border-opacity-75 mt-auto w-full"
          >
            <a
              href=""
            ...
            <span
              class="text-gray-500 mr-3 inline-flex items-center ml-auto leading-none text-sm pr-3 py-1 border-r-2 border-gray-800"
            >
              <svg
                class="w-4 h-4 mr-1"
                stroke="currentColor"
          ...
          <a href="" class="inline-flex items-center">
            ...
            <span class="flex-grow flex flex-col pl-4">
              <span
                class="title-font font-medium text-gray-900 dark:text-white"
              >
                Holden Caulfield
              </span>
              <span class="text-gray-500 text-xs tracking-widest mt-0.5"
                >UI DEVELOPER</span
              >
            </span>
          </a>
